            ...
            <div className="flex h-1/3 max-h-screen">
                ...
                <div className="flex relative bg-white h-screen">
                    ...
                    <div className="flex absolute right-60 h-80 w-96 top-28 items-center">
                        <p className="flex leading-10 text-white text-2xl m-2 p-4 bg-sky-800">A Empresa distingue-se pelo reconhecido elevado nível de serviço ao cliente, pelas suas
                    ...
                    <div className="static h-48 w-48 -left-4 bottom-4 bg-yellow-600">
                     ...
                     <div className="flex flex-col absolute items-center bg-slate-400 m-10 -bottom-80 h-98 w-3/4 left-36 ">
                        ...
                        <div className="grid grid-cols-3 gap-2 bg-slate-400 m-6 w-3/4">
                            <div className="flex flex-col w-full hover:scale-105 h-28 border-2 justify-end text-base text-center items-center border-slate-500 bg-slate-400"><img className="w-10" src="assessorar.png"/>Acessorar transações de venda e aquisição</div>
                            <div className="flex flex-col w-full hover:scale-105 h-28 border-2 justify-end items-center border-slate-500 bg-slate-400 pb-3"><img className="w-10" src="property.png"/>Consultoria Imobiliária</div>
                            <div className="flex flex-col w-full hover:scale-105 h-28 border-2 justify-end items-center border-slate-500 bg-slate-400 pb-3"><img className="w-10" src="consultoria.png"/>Consultoria de Gestão</div>
                            <div className="flex flex-col w-full hover:scale-105 h-28 border-2 justify-end items-center border-slate-500 bg-slate-400 pb-3"><img className="w-10" src="administrator.png"/>Contabilidade e apoio administrativo</div>
                            <div className="flex flex-col w-full hover:scale-105 h-28 border-2 justify-end items-center border-slate-500 bg-slate-400 pb-3"><img className="w-10" src="fiscalidade.png"/>Fiscalidade</div>
                            <div className="flex flex-col w-full hover:scale-105 h-28 border-2 justify-end items-center text-center border-slate-500 bg-slate-400 pb-3"><img className="w-10" src="procesamento.png"/>Processamento de Salários e Faturação</div>
                        </div>
                    </div>
                </div>
