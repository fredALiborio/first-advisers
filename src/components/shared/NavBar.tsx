  ...
  return (
    <div className="flex flex-row w-screen bg-slate-50">
      ...
      <div className="flex justify-end w-full items-center bg-slate-50 space-x-10 p-10 text-sky-900 text-lg font-semibold rounded-md">
        <Link href="/home">
          <a className="hover:opacity-60">Home</a>
        </Link>
        <Link href="/about_us" className="">
          <a className="hover:opacity-60">Sobre Nós</a>
        </Link>
        <Box
        ...
        <Link href="/clients" className="">
          <a className="hover:opacity-60">Parcerias</a>
        </Link>
        <Link href="/contacts" className="">
          <a className="hover:opacity-60">Contactos</a>
        </Link>
      </div>
      <div className="flex w-80 items-center ml-14 mr-4 space-x-3">
        <div>
          <SearchIcon size="5em" />
        </div>
        <Input
      ...
      <div className="w-32 mr-10 p-6 mt-2 ml-1">
        <a href="/login">
          <img src="user.png" />
        </a>
      </div>
